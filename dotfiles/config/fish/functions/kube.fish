...
function kubeworkmgmt --description "kubectl alias for workbench management cluster"
	...
	kubectl --context=gke_streamfitters-guild_us-east1_cramer-us-east-management-1 \
		--namespace=$namespace \
		$argv
end
...
function kubeworkexec --description "kubectl alias for workbench execution cluster"
	set -q namespace[1] or set namespace[1] "default"
	kubectl --context=gke_streamfitters-guild_us-east1_cramer-us-east-execution-1 --namespace=$namespace $argv
end
