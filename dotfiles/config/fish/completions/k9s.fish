...
function __k9s_prepare_completions
    ...
    set -l results (__k9s_perform_completion)
    __k9s_debug "Completion results: $results"
    ...
    set --global __k9s_comp_results $results[1..-2]
...
complete -c k9s -n '__k9s_prepare_completions' -f -a '$__k9s_comp_results'
